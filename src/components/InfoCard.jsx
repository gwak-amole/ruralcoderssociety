...
// my learning notes
    ...
    return(
        <div ref={cardRef} className="p-6 sm:p-8 w-full max-w-96 h-64 rounded-3xl border-blue-300 border-4 bg-blue-400 hover:-translate-y-0.5 hover:bg-blue-500 duration-150 ease-in-out">
