const InfoCard2 = ({ header = "", desc = "", image_link, height = 128}) => {
    return(
        <div className={`border-2 p-6 sm:p-8 w-full max-w-96 h-${height} rounded-3xl bg-blue-950 border-amber-400 hover:-translate-y-0.5 hover:bg-blue-900 duration-150 ease-in-out`}>
