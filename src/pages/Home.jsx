...
function Home() {
  const cards = [
  {number: 1965, prefix: "$", suffix: "+", desc: "raised for RCS programs", key: 1},
  {number: 51, prefix: null, suffix: "+", desc: "projects created with RCS", key: 2},
  ...
  return (
    <div className="text-center">
      <div className="h-144 w-full pt-22 bg-blue-950 text-center mb-75">
